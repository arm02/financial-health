...
type TransactionUseCase interface {
	...
	GetAllTransaction(ctx context.Context, userID int64, page, limit int, sortBy, sortType, query string, tipe string) (*RowsList[Transaction], error)
...
type TransactionRepository interface {
	...
	GetAll(ctx context.Context, userID int64, page, limit int, sortBy, sortType, query string, tipe string) ([]Transaction, int64, error)
