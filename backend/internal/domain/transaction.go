...
type TransactionUseCase interface {
	...
	GetAllTransaction(ctx context.Context, userID int64, page, limit int, sortBy, sortType, query string) (*RowsList[Transaction], error)
...
type TransactionRepository interface {
	...
	GetAll(ctx context.Context, userID int64, page, limit int, sortBy, sortType, query string) ([]Transaction, int64, error)
